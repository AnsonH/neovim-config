...
M.setup = function()
  ...
  local config = {
    -- disable virtual text (display LSP warning/error message at end of line)
    virtual_text = false,
    -- show signs
    signs = {
      active = signs,
...
-- Highlight word after waiting for `updatetime` amount of time (`updatetime` is set in options.lua)
...
M.on_attach = function(client, bufnr)
  -- Turns off formatting for JS/TS
